...
Zpracování sEMG signálu bylo založeno na kalibraci, filtraci a výpočtu aktivační proměnné s hysterezí. Tento postup odpovídá obecným principům zpracování elektromyografických signálů, u nichž je nutné potlačovat šum, artefakty a uživatelskou variabilitu.
