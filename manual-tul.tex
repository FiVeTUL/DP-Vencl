...
%\usepackage[CXI,fonts,noheader,EN]{tul}
\usepackage[FM,fonts,noheader,EN]{tul}
...
\begin{figure}[htp]
\begin{center}
{\fontspec{[TULMono-Regular.ttf]}Regular \TULmono \textbf{Bold} \fontspec{[TULMono-Hairline.ttf]}Hairline
\fontspec{[TULMono-SingleLine.ttf]}SingleLine}\\
\end{center}
